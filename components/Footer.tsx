        ...
        <footer className="border-t border-solid border-secondary-900 bg-background-dark py-12">
            <div className="mx-auto flex max-w-5xl flex-col items-center justify-between gap-8 px-4 sm:px-10 md:flex-row">
                ...
                <div className="flex items-center gap-4">
                    <a className="text-secondary-400 hover:text-white" href="https://www.instagram.com/professorlucassilva/" aria-label="Instagram" target="_blank" rel="noopener noreferrer">
                    ...
                    <a className="text-secondary-400 hover:text-white" href="https://www.linkedin.com/in/lucasdasilvaesilva/" aria-label="LinkedIn" target="_blank" rel="noopener noreferrer">
